...
public interface BookService {
	...
	// public int registerBook(MultipartHttpServletRequest mRequest); 위나 아래 둘 중에 하나
	// public int modifyBook(MultipartHttpServletRequest mRequest, Book book); 위나 아래 둘 중에 하나
